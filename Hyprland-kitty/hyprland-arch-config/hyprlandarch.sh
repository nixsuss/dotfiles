#!/bin/bash
set -eu
sudo pacman -S --needed --noconfirm wofi hypridle grim mako hyprpaper hyprlock jq wl-clipboard cliphist foot mpd-mpris pqiv hyprland xdg-desktop-portal-hyprland hyprland-qtutils waybar swww hyprland-protocols
