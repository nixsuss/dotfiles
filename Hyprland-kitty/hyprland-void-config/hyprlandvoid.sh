...
sudo xbps-install -Suy wofi seatd hypridle grim mako hyprpaper hyprlock jq wl-clipboard cliphist foot mpDris2 pqiv hyprland xdg-desktop-portal-hyprland hyprland-qtutils Waybar xorg-server-xwayland
