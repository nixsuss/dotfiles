...
sudo xbps-install -S xorg-minimal xrdb xrandr xprop setxkbmap xorg-server-devel nvidia gvim pipewire alsa-utils alsa-pipewire noto-fonts-emoji noto-fonts-ttf-extra dejavu-fonts-ttf elogind polkit polkit-gnome wireplumber libjack-pipewire neofetch rxvt-unicode base-devel libX11-devel libXft-devel libXinerama-devel git curl wget nitrogen scrot xdg-utils pcmanfm pavucontrol neofetch htop font-firacode breeze-cursors gvfs gvfs-mtp mtpfs gvfs-gphoto2 ntfs-3g dialog mtools smartmontools qt5ct qbittorrent slock xss-lock rsync mpv mpc mpd ncmpcpp zsh zsh-completions dconf-editor galculator-gtk3 ufw gparted gnome-disk-utility papirus-icon-theme breeze-icons kvantum picom amiri-font font-sil-scheherazade font-sil-lateef socklog-void torbrowser-launcher rofi dunst nerd-fonts yaru obfs4proxy numlockx clipmenu qt5-styleplugins xtools zathura-pdf-mupdf redshift sxiv xclip figlet figlet-fonts lolcat-c bottom dust yt-dlp bat lsd ffmpeg6 conky fribidi-devel kitty lf trash-cli terminus-font 7zip-unrar pfetch nwg-look leafpad nv-codec-headers pywal xdotool sound-theme-freedesktop zsh-autosuggestions zsh-syntax-highlighting engrampa wireless-regdb qt6ct
