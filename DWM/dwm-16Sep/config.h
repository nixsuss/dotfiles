...
static const char *clipmenu[] = { "clipmenu","-i","-fn","Comic Mono:size=14:style=Normal:antialias=true:hinting=true","-nb","#000000","-nf","#ffffff","-sb","#808080","-sf","#000000", NULL };
...
static const char dmenufont[]       = "Comic Mono:size=14:style=Normal:antialias=true:hinting=true";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_F5, 	   spawn, 	   {.v = slock } },
	{ MODKEY,                       XK_v,      spawn,          {.v = mpctoggle } },
