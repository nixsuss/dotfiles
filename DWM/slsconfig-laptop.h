...
//	{ disk_free, "^c#FFFFFF^󰋊 %sB free  ", "/" },
	{ ram_used, "^c#a6e3a1^ %sB  ", NULL	      },
//	{ ram_total, "^c#a6e3a1^%sB  ", NULL	      },
//	{ ram_perc, "^c#a6e3a1^ %s%%  ", NULL	      },
	{ temp, "^c#e25822^%s℃  ", "/sys/class/thermal/thermal_zone0/temp"	      },
	{ cpu_freq, "^c#7DF9FF^ %sHZ  ", NULL	      },
//	{ cpu_perc, "^c#7DF9FF^ %s%%  ", NULL	      },
//	{ netspeed_tx, "^c#FFEBCD^  %sB/s ", "enp3s0" },
//	{ netspeed_rx, "^c#FFEBCD^  %sB/s ", "enp3s0" },
	{ run_command, "^c#F38BA8^ %s ", "amixer sget Master | awk -F\"[][]\" '/%/ { print $2, $4 }' | head -n1" },
//	{ run_command, "^c#F38BA8^%s  ", "amixer sget Capture | awk -F\"[][]\" '/%/ { print $2, $4 }' | head -n1" },
