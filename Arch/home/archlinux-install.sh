...
chsh -s /bin/zsh
echo
echo "Add IgnorePkg=dmenu /etc/pacman.conf under [options]"
echo 
echo "*Optional*"
...
VerbosePkgLists
in /etc/pacman.conf"
echo "You can add ILoveCandy with them"
